---
title: "Udziały na rynku gier"
output:
  pdf_document: default
  html_document: default
date: "Inga Nowak, Igor Korczak-Kubalski, Jakub Olszewski"
---
...
- zbior danych dotyczacych sprzedazy gier wideo w latach 1980-2020, 16598 pozycji
...
```{r}
games <- read.csv("https://raw.githubusercontent.com/KayaKazuyoshi/Projekt-przej-ciowy-2/main/vgsales.csv")
summary(games)
str(games)
```
...
usuniecie danych z obecnej dekady (zeby nie zaburzyc analizy - obecna dekada sie jeszcze nie skonczyla i do konca jej trwania wydanych zostanie jeszcze wiele gier) = usuniecie 1 gry
...
platform_na_sales_plot
platform_eu_sales_plot
platform_jp_sales_plot
platform_other_sales_plot
```

#### OBSERWACJE

- Japonia -> konsola SNES (powstala w latach 90) ponad 50% sprzedazy w samej Japonii dominacja sprzedazy gier na konsole (PC w top10 tylko na rynku europejskim i na innych rynkach)
...
wnioski: niektore gatunki gier mimo wydania wiekszej liczby tytulow osiagaja mniejsze zyski np. wydano wiecej tytulow gier z gatunku "Adventure" niz "Racing", ale zyski ze sprzedazy byly duzo mniejsze
...
- gatunki ze sprzedaza ponizej sredniej sprzedazy globalnej: Strategy, Adventure, Puzzle, Siimulation, Fighting, Racing
- gatunki ze sprzedaza powyzej sredniej sprzedazy globalnej: Misc, Platform, Role-Playing, Shooter, Sports, Action
...
publisher_na_sales_plot
publisher_eu_sales_plot
publisher_jp_sales_plot
publisher_other_sales_plot
```
...
- spadek dominacji Nintendo -> wzrost zyskow (599 mln USD -> 1184 mln USD),ale spadek udzialow na rynku (36% -> 16,5%)
